      ...
      {!method && (
        <div className="space-y-3">
          ...
          <button onClick={() => setMethod('email')} className="w-full card-hover flex items-center gap-4 p-4 text-left group">
            <div className="w-10 h-10 rounded-lg bg-blue-500/10 border border-blue-500/20 flex items-center justify-center shrink-0 group-hover:border-blue-500/40">
        ...
        <div className="card animate-fade-in">
          ...
          {walletStep === 'connect' && (
            <div className="space-y-4">
              ...
              <p className="text-[10px] text-gray-500 text-center">No wallet? <a href="https://metamask.io" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">Install MetaMask</a></p>
            </div>
          )}
